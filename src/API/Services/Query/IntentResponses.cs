...
public static class IntentResponses
{
    ...
    public static string OutOfScope(string language) => Get(OutOfScopeResponses, language);

    public static string NoResults(string language) => Get(NoResultsResponses, language);
